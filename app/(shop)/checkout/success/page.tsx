    ...
    <div className="min-h-[70vh] flex flex-col items-center justify-center p-4">
      <div className="max-w-2xl w-full text-center space-y-6">
        <div className="w-24 h-24 bg-[#FDD79A]/20 rounded-full flex items-center justify-center mx-auto mb-8 border border-[#FDD79A]/40">
          <CheckCircle2 className="w-12 h-12 text-[#012169]" />
        </div>
        
        <h1 className="text-4xl md:text-5xl font-black text-[#012169] tracking-tight">
          Order Confirmed!
        </h1>
        
        <p className="text-lg text-[#434655] max-w-lg mx-auto leading-relaxed">
        ...
        <div className="pt-8 flex flex-col sm:flex-row items-center justify-center gap-4">
          ...
          <Link href="/">
            <Button size="lg" variant="outline" className="w-full sm:w-auto border-[#c4c5d8] text-[#012169] hover:bg-[#fbf8ff] font-bold px-8 h-14">
              Continue Shopping
